...
/*if(i==1){
 ...
 //ctx.drawImage(image,x5-width2+x3,y5-height2+y3,width,height);
 //ctx.drawImage(image,x5-width2-x4,y5-height2-y4,width,height); 
   ctx.drawImage(image,x5-width2,y5-height2,width,height); 
    // ctx.translate(x7-width2, y7-width2);
  // ctx.drawImage(image,(width1-width)/2-width2,(height1-height)/2-height2,width,height);
...
function zoomin() {
 ...
 x5=(width1-width)/2+x3;
 y5=(height1-height)/2+y3;
