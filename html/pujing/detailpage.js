 ...
 if((Number)(chapternumber)<(Number)(startchapter)){
	...
	//if((Boolean)(loginstate)){
		if(loginstate==1){
			...
			/*getusername_cookieurl="getusername_cookie.php";
			username= xMLHttpRequest("GET",getusername_cookieurl);*/
			
            username= document.cookie.substring(9);
			alert(username);
			var label_0=document.getElementById("label_0");
		label_0.textContent	=label_0.textContent+username;
...
var test_1=	function test_1(){

 loginurl = "login16.php";
//window.open(loginurl, "_blank");
window.open(loginurl, "_self");
 }
	var defaultstring="failed";
	var label_0=document.getElementById("label_0");
		label_0.textContent	=label_0.textContent+defaultstring;
	alert("logintypefailed");
	//setTimeout(test_1, 3*1000);
			
	setInterval(alert("test"), 1*1000);
	/*loginurl = "login16.php";
	window.open(loginurl, "_self");*/
