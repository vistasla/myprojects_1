...
CREATE TABLE `htmldocumentinfo` (
  ...
  `strFirstDegree` varchar(255) NOT NULL,
  `strSecondDegree` varchar(255) NOT NULL,
  `strOriginalTitle` varchar(255) NOT NULL,
  `strArrayImage` varchar(1024) NOT NULL,
  `strArraySmallImage` varchar(1024) NOT NULL,
  `strTitleOriginal` varchar(255) NOT NULL,
  `strAuthor` varchar(255) NOT NULL,
  `strPublishingHouse` varchar(255) NOT NULL,
  `strPublishingTime` varchar(255) NOT NULL,
  `strFormat` varchar(255) NOT NULL,
  `strPaper` varchar(255) NOT NULL,
  `strPackaging` varchar(255) NOT NULL,
  `strIsbn` varchar(255) NOT NULL,
  `strContent` varchar(4096) NOT NULL,
  `strAuthorIntroduction` varchar(4096) NOT NULL,
  `strCatalog` varchar(4096) NOT NULL,
  `strKeywords` varchar(1024) NOT NULL,
  PRIMARY KEY (`strIsbn`,`strUrl`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of htmldocumentinfo
-- ----------------------------
...
-- ----------------------------
-- Records of htmldocumentinfo0_copy
-- ----------------------------
